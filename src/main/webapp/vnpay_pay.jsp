         ...
         <div class="container">
           <div class="header clearfix">
            ...
            <div class="table-responsive">
                <form action="/mavenproject8/vnpayajax" id="frmCreateOrder" method="post">        
                    <div class="form-group">
                        ...
                        <input readonly class="txt_inv_mobile form-control" name="txt_inv_mobile" id="txt_inv_mobile" value=<%=txt_inv_mobile%>></input><!-- comment -->
						<label for="amount">Ten khach hang</label>
						<input readonly class="txt_inv_custome form-control" name="txt_inv_custome" id="txt_inv_custome" value=<%=txt_inv_customer%>></input>
			        	<label for="amount">So ve</label>

 ...
 * @author lasin
 */
@WebServlet("/TaiXeControl")
public class TaiXeControl extends HttpServlet{
    private DAO testdao;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException{
        String tentaixe=req.getParameter("Uname"); 
        String sdttaixe=req.getParameter("Sdt"); 
        int rows=testsimpledao.themTaixe(tentaixe, sdttaixe);
